...
const LANG = {
  it: {
    ...
    ctaBridgeSub: "La seconda cambia il sito.",
  ...
  en: {
    ...
    ctaBridgeSub: "The second one changes the site.",
    ...
    ch2: {
      ...
      bridgeLine: "I couldn't carry everything forward. I had to understand what remained.",
      continueFeedback: [
...
function ChapterTwoScene({ lang, T, onBack, onComplete, profileUi, profileEntries, unlockedProfileIds, currentProfileId, onUnlockProfile }) {
  ...
  const handleStepOut = useCallback(() => {
    if (deskTransitioning) return;
    setDeskFeedbackText(T.bridgeLine);
...
function ChapterFourScene({ T, onBack, onContact, onComplete, profileUi, profileEntries, unlockedProfileIds, currentProfileId, onUnlockProfile }) {
  ...
  }, [getNorm, startLoop, startCartLoop, sceneReady]);
